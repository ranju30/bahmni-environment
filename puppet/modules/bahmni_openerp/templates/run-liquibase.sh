...
CREDS="--url=jdbc:postgresql://<%= scope['config::db_server'] %>:5432/openerp --username=postgres --password=postgres"
CLASSPATH="<%= scope['config::build_output_dir'] %>/<%= @openerp_atomfeed_war_file_name %>.war"
