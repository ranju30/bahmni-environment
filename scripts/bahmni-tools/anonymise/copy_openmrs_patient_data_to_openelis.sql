...
WHERE patient.uuid = temp_openmrs_patient.uuid AND patient_identity.patient_id = patient.id
...
WHERE patient.uuid = temp_openmrs_patient.uuid AND person.id = patient.person_id;
...
WHERE patient.uuid = temp_openmrs_patient.uuid;
